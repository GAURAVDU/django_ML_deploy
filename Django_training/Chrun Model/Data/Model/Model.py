...
data = pd.read_csv(
    r"C:\Users\imgau\Documents\Python Code Directory\Django_training\Chrun Model\Data\archive\glass.csv"
)
# print(data.head())
...
def result_using_tree_classifier(x_train, x_test, y_train, y_test):
    ...
    algos2 = {
        "decision tree": {
            ...
            "param": {
                ...
                "max_depth": np.arange(1, 6, 1).tolist(),
            },
        },
        "random forest": {
    ...
    return (
        pd.DataFrame(scores, columns=["model", "best_score", "best_para"])
        .set_index("model")
        .reset_index()
    )
